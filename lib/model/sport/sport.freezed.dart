...
class _$SportTearOff {
  ...
  _Sport call({required int id, required String name}) {
    return _Sport(
      id: id,
      name: name,
    );
...
class _$_Sport implements _Sport {
  _$_Sport({required this.id, required this.name});

  factory _$_Sport.fromJson(Map<String, dynamic> json) =>
      _$_$_SportFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$_$_SportToJson(this);
  }
}

abstract class _Sport implements Sport {
  factory _Sport({required int id, required String name}) = _$_Sport;
